...
const PRODUCTS_DATA = {
  ...
  'in-stock': [

   {
      ...
      subtitle: 'Чистый зрелый мёд с семейной пасеки',
      description:
        'Натуральный мёд с собственной пасеки. Без сахара, добавок и термической обработки. Густой, ароматный и полезный.',
      images: [
        'assets/catalog/in-stock/honey-glass-1.jpg',
        'assets/catalog/in-stock/honey-glass-2.jpg',
      ],
      weights: [
        { label: 'Банка 500 г', value: 500, price: 600 },
        { label: 'Банка 1 кг', value: 1000, price: 1100 },
      ],
      fillings: null,
      basePrice: 600,
      unit: 'г',
...

    {
      ...
      category: 'in-stock',
      name: 'Мёд в сотах',
      subtitle: 'Цельные соты прямо из улья',
      description:
        'Свежий зрелый мед в натуральных восковых сотах. Запечатан самими пчелами, воск чистый и полезный для десен.',
      images: [
        'assets/catalog/in-stock/honeycomb.jpg',
      ],
      weights: [
        { label: 'Рамка / брусок (~400 г)', value: 400, price: 700 },
        { label: 'Большой срез (~800 г)', value: 800, price: 1300 },
      ],
      fillings: null,
      basePrice: 700,
      unit: 'г',
...

    {
      ...
      description:
        'Майский сбор дикорастущих трав с высокогорных полей Дагестана: мята, полынь и душистый чабрец. Высушены естественным способом с сохранением эфирных масел.',
      images: [
      ...
      weights: [
        { label: 'Крафт-пакет (50 г)', value: 50, price: 300 },
        { label: 'Крафт-пакет (100 г)', value: 100, price: 550 },
      ],
      fillings: null,
      basePrice: 300,
      unit: 'г',
...

    {
      ...
      description:
        'Чистая сотовая перга ручной выборки с нашей пасеки. Натуральный источник витаминов и аминокислот для иммунитета.',
      images: [
        'assets/catalog/in-stock/bee-perga.jpg',
      ],
      weights: [
        { label: '100 г', value: 100, price: 700 },
        { label: '200 г', value: 200, price: 1300 },
      ],
      fillings: null,
      basePrice: 700,
      unit: 'г',
...

    {
      ...
      description:
        'Натуральная цветочная пыльца (обножка), собранная на горных лугах. Отличная добавка к ложке меда, кашам или воде.',
      images: [
        'assets/catalog/in-stock/bee-pollen-1.jpg',
        'assets/catalog/in-stock/bee-pollen-2.jpg',
      ],
      weights: [
        { label: '100 г', value: 100, price: 500 },
        { label: '200 г', value: 200, price: 950 },
      ],
      fillings: null,
      basePrice: 500,
      unit: 'г',
...

    {
      ...
      subtitle: 'Для настоек и оздоровления',
      description:
        'Сухой пчелиный подмор от здоровых пчелиных семей с семейной пасеки. Используется для целебных настоек и растирок.',
      images: [
        'assets/catalog/in-stock/bee-podmor.jpg',
      ],
      weights: [
        { label: '50 г', value: 50, price: 350 },
        { label: '100 г', value: 100, price: 600 },
      ],
      fillings: null,
      basePrice: 350,
      unit: 'г',
