...
const PRODUCTS_DATA = {
...

  {
      ...
      description:
        'Собственная семейная пасека. Чистый натуральный мед без добавок, сахара и термической обработки. Фасуется в удобные ведёрки объёмом 1 литр (около 1.5 кг чистого веса).',
      images: [
